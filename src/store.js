            ...
            state.websock.onmessage = function (e) {
                ...
                if (data.newNodeParam && data.editMethod == "Add") {
                    ...
                    var params = {
                        ...
                        startArrowType: data.lineParams.startArrowType,
                        endArrowType: data.lineParams.endArrowType,
                        startArrowId: data.lineParams.startArrowId,
                        endArrowId: data.lineParams.endArrowId,
                        startArrow: data.lineParams.startArrow,
                        endArrow: data.lineParams.endArrow,
                        startArrowStyle: data.lineParams.startArrowStyle,
                        endArrowStyle: data.lineParams.endArrowStyle,
