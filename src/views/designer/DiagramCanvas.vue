...
export default {
    ...
    methods: {
        ...
        middleRight() {
            console.log("右中");
            if (this.eStartY < this.eEndY) {
                this.svgLeft = this.eStartX + this.eStartW;
                this.svgTop = this.eStartY;
                this.svgWid = this.eEndX - this.svgLeft;
                this.svgHei = this.eEndY + this.eEndH - this.svgTop;
            } else {
            ...
            this.lineStartX = parseInt(this.$store.state.lineSize) * 3;
            this.lineStartY = this.eStartY + this.eStartH * 0.5 - this.svgTop;
            this.lineEndX =
                this.eEndX -
                parseInt(this.$store.state.lineSize) * 3 -
                this.svgLeft;
        ...
        moveMiddleLeft(
            ...
            lineSX = startLeft - parseInt(linesize) * 3 - svgLeft;
            lineSY = startTop + startHeight * 0.5 - parseInt(linesize) - svgTop;
            lineEX = endLeft + endWidth + parseInt(linesize) * 3 - svgLeft;
            lineEY = endTop + endHeight * 0.5 + parseInt(linesize) - svgTop;
            if (relationType == "straight") {
                linePath =
                    "M" + lineSX + " " + lineSY + " L " + lineEX + " " + lineEY;
            }
        ...
        moveMiddleRight(
            ...
            lineSX = parseInt(lineSize) * 3;
            lineSY = startTop + startHeight * 0.5 - svgTop;
            lineEX = endLeft - parseInt(lineSize) * 3 - svgLeft;
            lineEY = endTop + endHeight * 0.5 - parseInt(lineSize) * 3 - svgTop;
            if (relationType == "straight") {
                linePath =
                    "M" + lineSX + " " + lineSY + " L " + lineEX + " " + lineEY;
            }
